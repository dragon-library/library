    ...
    return (
      React.createElement("div", null,
        React.createElement("div", { className: "row" },
          React.createElement("div", { className: "col-lg-6 col-lg-offset-3" },
            React.createElement("div", { className: "text-center" }
            ))),
        React.createElement("div", { className: "row" },
          React.createElement("div", { className: "col-lg-12" },
            React.createElement(Clock, { size: 350, timeFormat: "24hour", hourFormat: "standard" })))));
  }
}
class Clock extends React.Component {
  ...
  drawNumbers(ctx, radius) {
    ...
    //ctx.fillText("ด.ช.พชรพล วงศ์สง่า", 0, 0);
    ctx.translate(0, -radius * 0.30);
  }
  ...
  render() {
    return (
      React.createElement("div", { className: "Clock", style: { width: String(this.props.size) + 'px' } },
