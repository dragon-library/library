...
def match_icon_tmd(data):
    ...
    if data.lower() in desc:
        return desc[data.lower()]
    else:
        
        return 'weather'


def weather_thai_condition(data):

    conditions = {
        'clear sky': 'ท้องฟ้าแจ่มใส',
        'few clouds':  'ท้องฟ้ามีเมฆบางส่วน',
        'scattered clouds':  'ท้องฟ้ามีเมฆเป็นส่วนมาก',
        'broken clouds': 'ท้องฟ้ามีเมฆมาก',
        'shower rain': 'มีฝนตกเล็กน้อย',
        'rain':  'มีฝนตก',
...
def match_tmd_condition(data):

    conditions = {
        'ท้องฟ้าแจ่มใส':'1d',
        'ท้องฟ้าโปร่ง':'1d',
        'ท้องฟ้ามีเมฆบางส่วน':'2d',
        'ท้องฟ้าเมฆเป็นส่วนมาก':'3d',
        'ท้องฟ้ามีเมฆมาก':'4d',
        'ฝนตกเล็กน้อย':'5d',
        'ฝนปานกลาง':'6d',
        'ฝนตกหนัก':'7d',
...
def tmd_weather_condition(data):
    conditions = {
        1: 'ท้องฟ้าแจ่มใส',
        2: 'ท้องฟ้ามีเมฆบางส่วน',
        3: 'ท้องฟ้าเมฆเป็นส่วนมาก',
        4: 'ท้องฟ้ามีเมฆมาก',
        5: 'ฝนตกเล็กน้อย',
        6: 'ฝนปานกลาง',
        7: 'ฝนตกหนัก',
