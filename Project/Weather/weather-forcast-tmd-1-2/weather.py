...
# daily กรมอุตุนิยมวิทยา

def daily_tmd(amphoe=None,province="สมุทรปราการ"):
    import requests

    url = "https://data.tmd.go.th/nwpapi/v1/forecast/location/daily/place"

    querystring = {"province":{province}, "amphoe":{amphoe}, "fields":"tc,tc_max,tc_min,rh,ws10m,wd10m,swdown,cond", "hour":"8", "duration":"7"}
...
def forecast_tmd(amphoe=None,province="สมุทรปราการ"):
